...
`;function sg({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=bs,iterationCount:o=1}){return Xd`
  ...
  `}function ug(e){return e==null}function cg(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"}function qd(e,t){return n=>n?e():t()}function Rr(e){return qd(e,()=>null)}function wa(e){return Rr(()=>({opacity:0}))(e)}const Lt=e=>{const{cascade:t=!1,damping:n=.5,delay:r=0,duration:o=1e3,fraction:l=0,keyframes:i=bs,triggerOnce:a=!1,className:s,style:c,childClassName:h,childStyle:m,children:g,onVisibilityChange:k}=e,y=v.useMemo(()=>sg({keyframes:i,duration:o}),[o,i]);return ug(g)?null:cg(g)?te(dg,{...e,animationStyles:y,children:String(g)}):K1.isFragment(g)?te(e0,{...e,animationStyles:y}):te($1,{children:v.Children.map(g,(x,C)=>{if(!v.isValidElement(x))return null;const d=r+(t?C*o*n:0);switch(x.type){case"ol":case"ul":return te(xi,{children:({cx:f})=>te(x.type,{...x.props,className:f(s,x.props.className),style:Object.assign({},c,x.props.style),children:te(Lt,{...e,children:x.props.children})})});case"li":return te(ec,{threshold:l,triggerOnce:a,onChange:k,children:({inView:f,ref:p})=>te(xi,{children:({cx:w})=>te(x.type,{...x.props,ref:p,className:w(h,x.props.className),css:Rr(()=>y)(f),style:Object.assign({},m,x.props.style,wa(!f),{animationDelay:d+"ms"})})})});default:return te(ec,{threshold:l,triggerOnce:a,onChange:k,children:({inView:f,ref:p})=>te("div",{ref:p,className:s,css:Rr(()=>y)(f),style:Object.assign({},c,wa(!f),{animationDelay:d+"ms"}),children:te(xi,{children:({cx:w})=>te(x.type,{...x.props,className:w(h,x.props.className),style:Object.assign({},m,x.props.style)})})})})}})})},fg={display:"inline-block",whiteSpace:"pre"},dg=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:o=0,duration:l=1e3,fraction:i=0,triggerOnce:a=!1,className:s,style:c,children:h,onVisibilityChange:m}=e,{ref:g,inView:k}=Zd({triggerOnce:a,threshold:i,onChange:m});return qd(()=>te("div",{ref:g,className:s,style:Object.assign({},c,fg),children:h.split("").map((y,x)=>te("span",{css:Rr(()=>t)(k),style:{animationDelay:o+x*l*r+"ms"},children:y},x))}),()=>te(e0,{...e,children:h}))(n)},e0=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,className:o,style:l,children:i,onVisibilityChange:a}=e,{ref:s,inView:c}=Zd({triggerOnce:r,threshold:n,onChange:a});return te("div",{ref:s,className:o,css:Rr(()=>t)(c),style:Object.assign({},l,wa(!c)),children:i})};j`
  from,
  20%,
  40%,
  60%,
